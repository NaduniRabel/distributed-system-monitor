...
const (
	MetricService_StreamMetrics_FullMethodName = "/metrics.MetricService/StreamMetrics"
)
...
type MetricServiceClient interface {
	StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Metrics, Response], error)
}
...
func (c *metricServiceClient) StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Metrics, Response], error) {
...
type MetricService_StreamMetricsClient = grpc.ClientStreamingClient[Metrics, Response]
...
type MetricServiceServer interface {
	StreamMetrics(grpc.ClientStreamingServer[Metrics, Response]) error
...
func (UnimplementedMetricServiceServer) StreamMetrics(grpc.ClientStreamingServer[Metrics, Response]) error {
...
func _MetricService_StreamMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MetricServiceServer).StreamMetrics(&grpc.GenericServerStream[Metrics, Response]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MetricService_StreamMetricsServer = grpc.ClientStreamingServer[Metrics, Response]
